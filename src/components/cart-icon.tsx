...
export default function CartIcon() {
  ...
  return (
    <>
      <div
        className="fixed left-4 top-1/2 transform -translate-y-1/2 bg-black text-white rounded-full border-white w-14 h-14 flex items-center justify-center shadow-lg hover:scale-110 transition-transform"
        title="Go to Cart"
      >
      <Link href={"/cart"}>
      <h1
        className="text-2xl hover:text-red-500 font-bold uppercase relative group overflow-hidden duration-300"
      >
      ...
      <div
        className="fixed left-4 top-72 transform -translate-y-1/2 bg-black text-white border-white rounded-full w-14 h-14 flex items-center justify-center shadow-lg hover:scale-110 transition-transform"
