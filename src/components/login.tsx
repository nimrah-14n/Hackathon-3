...
const Login = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row w-full h-[600px]">
      {/* Right Section */}
      <div className="flex-1 mb-4 mt-4 flex justify-center items-center">
        <SiNike size={150} className="text-black" />
      </div>
        ...
        <SignedIn>
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="mt-4 text-lg text-center">
              ...
              <span className="font-bold text-black">nikeee</span> to get a
