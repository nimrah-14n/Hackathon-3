...
import { airProductsQuery } from '@/sanity/lib/queries';
import { Product } from '../../types/product';

export default function AirHomeProducts() {
  ...
  useEffect(() => {
    async function fetchProducts() {
      const products: Product[] = await client.fetch(airProductsQuery);
        ...
        <div className="flex items-center justify-between">
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-2">
              <span className="text-sm sm:text-base font-semibold">Best Of Air Max</span>
            </div>
